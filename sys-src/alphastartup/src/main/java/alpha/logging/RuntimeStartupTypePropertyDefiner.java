 ...
 **************************************************************************
 * $Id: RuntimeStartupTypePropertyDefiner.java 3598 2012-02-20 18:33:33Z cpn $
 *************************************************************************/
 ...
 * 
 */
public class RuntimeStartupTypePropertyDefiner extends PropertyDefinerBase {
	...
	public String getPropertyValue() {
		...
		String selfURI = RuntimeStartupTypePropertyDefiner.getClassURI(this
				.getClass());
		selfURI = RuntimeStartupTypePropertyDefiner
				.removeClassUriPrefix(selfURI);
		selfURI = RuntimeStartupTypePropertyDefiner
				.removePostJarSuffix(selfURI);
		final String homePath = RuntimeStartupTypePropertyDefiner
				.removeExtention(selfURI) + "/";
		final boolean selfIsExistingAlphaDoc = new File(homePath).exists();

		return (selfIsExistingAlphaDoc) ? "a-Doc" : "alph-o-matic";
	}
	...
	public static String getRunningJarName(
			@SuppressWarnings("rawtypes") final Class clazz) {
		final String classURI = RuntimeStartupTypePropertyDefiner
				.getClassURI(clazz);

		String jarName = null;
		if (RuntimeStartupTypePropertyDefiner.isRunningAsJar(classURI)) {
